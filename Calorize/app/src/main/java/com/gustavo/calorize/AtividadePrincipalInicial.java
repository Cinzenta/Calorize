...
public class AtividadePrincipalInicial extends AppCompatActivity {
    ...
    private static final String TAG = "AtividadePrincipalInicial"; // TAG para logs

    private LinearLayout layoutListaUsuarios;
    private DaoUsuario daoUsuario;
    // Removido: private ServicoApi servicoApi; // Não utilizado
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnAdicionarNovoUsuario = findViewById(R.id.btn_add_new_user);
    ...
    private void navegarParaAtividadePrincipal(Usuario usuario) {
        Intent intent = new Intent(AtividadePrincipalInicial.this, AtividadePrincipal.class);
        intent.putExtra(Constantes.EXTRA_USUARIO_OBJETO, usuario);
