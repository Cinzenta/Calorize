...
public class AlimentoConsumido implements Serializable {
    ...
    private String tipoRefeicao; // "Café da Manhã", "Almoço",
    ...
    public void setAlimentoOriginalId(Long alimentoOriginalId) { this.alimentoOriginalId = alimentoOriginalId; }
    public void setNomeAlimento(String nomeAlimento) { this.nomeAlimento = nomeAlimento; }
    public void setCaloriasConsumidas(double caloriasConsumidas) { this.caloriasConsumidas = caloriasConsumidas; }
    public void setProteinasConsumidas(double proteinasConsumidas) { this.proteinasConsumidas = proteinasConsumidas; }
    public void setCarboidratosConsumidas(double carboidratosConsumidas) { this.carboidratosConsumidas = carboidratosConsumidas; }
    public void setGordurasConsumidas(double gordurasConsumidas) { this.gordurasConsumidas = gordurasConsumidas; }
    public void setGramasConsumidas(double gramasConsumidas) { this.gramasConsumidas = gramasConsumidas; }
