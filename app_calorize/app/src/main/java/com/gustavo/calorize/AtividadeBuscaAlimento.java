...
import android.view.View; // Importar View para GONE e VISIBLE
...
import androidx.annotation.NonNull; // Para as anotações NonNull
import androidx.annotation.Nullable; // Para o @Nullable String searchTerm
...
import java.io.IOException; // lida com exceção de IO
